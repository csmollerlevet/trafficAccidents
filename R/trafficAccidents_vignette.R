#'This package contains functions to retrieve crash information data from the US National Highway Traffic Safety Administration's Faulty Analysis Reporting System, which is a nationwide census providing the American public yearly data regarding fatal injuries suffered in motor vehicle traffic crashes. There are two main functions available in the package:
#'
#'fars_summarize_years function can retrieve total number of crashes per month per year fars_map_state function plots the location of crashes per state per year
#'
